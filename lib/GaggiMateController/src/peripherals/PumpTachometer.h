...
class PumpTachometer {
  public:
    struct Config {
        ...
        // ISR holdoff window for burst-noise rejection.
        uint32_t holdoffMinUs = 250;
        uint32_t holdoffMaxUs = 1500;
        uint32_t holdoffPeriodDivisor = 8;
  ...
  private:
    ...
    static constexpr mcpwm_capture_channel_id_t MCPWM_CAPTURE_CHANNEL =
        MCPWM_SELECT_CAP0;
