...
This repo includes host-side shot capture tooling in `tools/telemetry/` for automatic `.csv` + `.metadata.json` generation from serial telemetry. See `docs/telemetry.md`.
